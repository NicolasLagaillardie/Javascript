...
var listeProgrammes = document.createElement("p") ;
listeProgrammes.id = "listeP" ;
listeProgrammes.textContent = 'En voici une ' ;
document.getElementById("contenu").appendChild(listeProgrammes) ;
document.getElementById("listeP").innerHTML += '<a href=" https://fr.wikipedia.org/wiki/Liste_des_langages_de_programmation">liste</a>';
document.getElementById("listeP").innerHTML += ' plus complète.';