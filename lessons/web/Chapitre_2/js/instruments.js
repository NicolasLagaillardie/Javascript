...
function infosLiens() {
    ...
    console.log(document.querySelector("a").href) ;
    console.log(document.getElementsByTagName("a")[document.getElementsByTagName("a").length - 1].href)
}

infosLiens() ;

function possede (elt, classe) {
    if (document.getElementById(elt).classList.contains(classe)) {
        console.log(true);
    } else {
        console.log(false);
}
