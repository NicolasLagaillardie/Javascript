    ...
    attaquer: function (cible) {
        if (this.sante > 0) {
            ...
            if (cible.sante > 0) {
                ...
                this.pieceOr = this.pieceOr + cible.pieceOr;
                cible.cle = 0;
                cible.pieceOr = 0;
...
Joueur.decrire = function () {
    var description = this.nom + " a " + this.sante + " points de vie, " +
        this.force + " en force et " + this.xp + " points d'expérience, " + this.pieceOr + " pièces d'or et " + this.cle + " clés";
    return description;
};
...
Joueur.combattre = function (adversaire) {
    ...
    if (adversaire.sante === 0) {
        console.log(this.nom + " a tué " + adversaire.nom + " et gagne " +
            adversaire.valeur + " points d'expérience, " + this.pieceOr + " pièces d'or et " + this.cle + " clés" );
